...
{
    public class DrawGraphics_H_and_Errors : AbstractDraw
    {
        private Panel panel;
        ...
        public DrawGraphics_H_and_Errors(IMethod method, Panel panel, bool IsMethod3) : base(method)
        {
            this.panel = panel;
